...
- การคลิกทีปุ่ม ครั้งต่อมา จะเปลี่ยนค่าในปุ่ม
    ...
    1. ปุ่มให้คะแนน จาก `1` <i class="fas fa-circle-arrow-right"></i> `0` <i class="fas fa-circle-arrow-right"></i> `NA` (เฉพาะเกณฑ์ที่่สามารถ `NA` ได้) ตามลำดับ
    1. ปุ่มหักคะแนน จาก `0` <i class="fas fa-circle-arrow-right"></i> `1` เพื่อหักคะแนน

<div class="warning">

ปุ่มคะแนน ที่สามารถ `NA` ได้ จะมีขอบหนากว่าปุ่มคะแนนทั่วไป

ปุ่มคะแนน ในหัวข้อที่กำหนดค่า `NA`,`M` หรือ `N` ไว้ (มีเครื่องหมาย <i class="fas fa-xmark"></i>) จะแก้ไขไม่ได้ทั้งหัวข้อ จนกว่าจะยกเลิก `NA`,`M` และ `N`
