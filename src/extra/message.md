# ระบบข้อความ
แสดงจำนวนข้อความใหม่ที่ยังไม่ได้อ่าน เหนือรูปจดหมาย <i class="fa fa-envelope"></i> ที่เมนูด้านขวา ใกล้กับชื่อผู้ใช้
![Message Badge](images/message-badge.webp)

เมื่อคลิกที่เมนูรูปจดหมาย <i class="fa fa-envelope"></i> จะมีเมนูย่อย ได้แก่
