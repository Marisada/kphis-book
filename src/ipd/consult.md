...
* <i class="fa fa-search" style="color:orange;"></i> `ค้นหา` : เพื่อสั่งการค้นหา
* <i class="fa fa-repeat" style="color:orange;"></i> `กลับสู่การค้นหาเริ่มต้น` : แก้ไขตัวกรองทั้งหมด กลับสู่จุดเริ่มต้น